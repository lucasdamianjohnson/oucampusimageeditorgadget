    ...
    max-width:none;
        ...
        <body class="body-pad">
          ...
          <form method="post">
                <?php  
                  $display = "none";
                if ($_SESSION["sizes"][$_SESSION["current_stage"]] =="Vertical") { $display="block";}?>
              <div style="display: <?php echo $display;?>;"><label for="constrain" class="constrain">Constrain aspect?</label><input type = "checkbox" id = "constrain" name = "constrain" value = "constrain" 
               checked/></div>
        ...
        <body  class="body-pad">
          ...
          $width = $_SESSION["original_size"][0];
            foreach($_SESSION["selection"] as $index =>$crop){
              ...
              echo "<h3>".$size."</h3>";
                echo "<strong>These sizes will be generated</strong><ul>";
